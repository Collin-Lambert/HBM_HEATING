...
#set_property PACKAGE_PIN F30 [get_ports final_out]
#set_property IOSTANDARD LVCMOS18 [get_ports final_out]

set_property ALLOW_COMBINATORIAL_LOOPS_TRUE [get_nets -of_objects[get_cells RO_*]]
